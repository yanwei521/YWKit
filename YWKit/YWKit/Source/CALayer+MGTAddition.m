...
#import "CALayer+MGTAddition.h"
#import "MGTCGUtil.h"

@implementation CALayer (MGTAddition)
...
- (UIViewContentMode)contentMode {
    return MGTCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = MGTUIViewContentModeToCAGravity(contentMode);
}
